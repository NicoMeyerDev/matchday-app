...
from .serializers import (
    LineupSerializer,
    LineupSlotSerializer,
    LineupSubstituteSerializer,
)
...
class LineupViewSet(ModelViewSet):
    ...
    und Ersatzspieler hinzuzufügen. Dadurch bleiben die Frontend-API-Aufrufe
    leicht verständlich.
    """

    queryset = (
        Lineup.objects.select_related("formation")
        .prefetch_related("slots__position", "slots__player", "substitutes__player")
        .all()
        .order_by("-updated_at")
    )
    ...
    def get_queryset(self):
        ...
        return (
            Lineup.objects.filter(club__in=clubs)
