...
class Training(models.Model):
    ...
    club = models.ForeignKey(
        "clubs.Club", related_name="trainings", on_delete=models.CASCADE
    )
    name = models.CharField(max_length=120)
    date = models.DateField()
    time = models.TimeField()
    trainingsart = models.CharField(
        max_length=10,
        blank=True,
        choices=[("klassisch", "Klassisches Training"), ("frei", "Freies Training")],
    )
...
class TrainingsBlock(models.Model):
    ...
    training = models.ForeignKey(
        "Training", related_name="blocks", on_delete=models.CASCADE
    )
    name = models.CharField(max_length=120)
    trainingstyp = models.CharField(
        max_length=20,
        blank=True,
        choices=[
...
class Uebung(models.Model):
    ...
    club = models.ForeignKey(
        "clubs.Club", related_name="uebungen", on_delete=models.CASCADE
    )
    name = models.CharField(max_length=120)
